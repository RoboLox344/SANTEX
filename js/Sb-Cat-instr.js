const ROOT_SUBCT_OTOPLENIE = document.getElementById('SubСtInstr');

const SUBCATALOG_INSTRUMENT = [
    {
        id:'001',
...
//подкаталог
class SubCatalogInstr {

    render(){
        let HtmlSubCatalogInstr = '';
        SUBCATALOG_INSTRUMENT.forEach(({id, name}) => {
        ...
        ROOT_SUBCT_OTOPLENIE.innerHTML = HtmlSubCatalogInstr;
    };
};
const SubCTOtpPage = new SubCatalogInstr();
SubCTOtpPage.render();

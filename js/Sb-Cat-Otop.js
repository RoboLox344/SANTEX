//roots
const ROOT_SUBCT_OTOPLENIE = document.getElementById('SubСtOtop');

const SUBCATALOG_OTOPLENIE = [
    {
        id:'001',
        name:'Котеальная разводка',
    },
    {
        id:'002',
        name:'Котеальное оборудование',
    },
    {
        id:'003',
    ...
    {
        id:'007',
        name:'Системы защиты от протечеки воды',
    },
    {
        id:'008',
...
class SubCatalogOtoplenie {
    ...
    render(){
        ...
        ROOT_SUBCT_OTOPLENIE.innerHTML = HtmlSubCatalogOtoplenie;
    };
};
const SubCTOtpPage = new SubCatalogOtoplenie();
SubCTOtpPage.render();
...
/* var newCartCount = arrCards; */
;
/* class Products{

    render(){
      let HtmlCatalog = '';
      newCartCount.forEach(({id, name, price, img, art, sale}) => {
  ...
  const arrCards = CATALOG__Base.slice(0, COUNT_SHOW_CART);
  ...
  buttonMore.addEventListener('click', function(){
    ...
    newCartCount +=4;
    var dopCart = CATALOG__Base.slice(newCartCount-4, newCartCount);
    CreadeCart(dopCart)
    if(CATALOG__Base.length == newCartCount){
  ...
  function OpacityButtun(){
    if (CATALOG__Base.length < 12){
        buttonMore.style.display = 'none';
    }
    
  };
  OpacityButtun(CATALOG__Base);